...
- [ PARTE 1: Fundamentos del NLP](#-parte-1-fundamentos-del-nlp)
    ...
    - [2 Stemming & Lemmatization](#2-stemming--lemmatization)
...
- [ PARTE 3: Representaciones Vectoriales](#-parte-3-representaciones-vectoriales)
    ...
    - [9 Language Models](#9-language-models)
- [ PARTE 4: NLP Moderna](#-parte-4-nlp-moderna)
    - [ Modern LLMs](#-modern-llms)
        - [APIs y LLMs Locales](#apis-y-llms-locales)
...
- [ Observabilidad y Testing de LLMs](#-observabilidad-y-testing-de-llms)
...
- [ Seguridad y Safety en LLMs](#-seguridad-y-safety-en-llms)
    ...
    - [Rate Limiting y Abuse Prevention](#rate-limiting-y-abuse-prevention)
    - [Best Practices Checklist](#best-practices-checklist)
- [ Evaluación y Métricas](#-evaluación-y-métricas)
- [ Pitfalls Comunes](#-pitfalls-comunes)
